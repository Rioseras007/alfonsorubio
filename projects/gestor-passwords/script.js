document.addEventListener('DOMContentLoaded', () => {
    ...
    // PWA Support: Registration and Install Logic
    let deferredPrompt;
    const installBtn = $('pwa-install-btn');
    const installBtnSettings = $('pwa-install-btn-settings');
    ...
    window.addEventListener('beforeinstallprompt', (e) => {
        ...
        if (pwaStatusText) pwaStatusText.style.display = 'none';
    ...
    const handleInstallClick = async () => {
        ...
        if (pwaStatusText) pwaStatusText.style.display = 'block';
    };
    ...
    window.addEventListener('appinstalled', (evt) => {
        console.log('PWA: Vaultify was installed');
        showToast('¡Vaultify instalado con éxito!');
        if (installBtn) installBtn.style.display = 'none';
        if (installBtnSettings) installBtnSettings.style.display = 'none';
        if (pwaStatusText) pwaStatusText.style.display = 'block';
    });
