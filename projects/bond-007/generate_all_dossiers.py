...
EXTRA_DATA = {
    "dr_no": {
        ...
        "runtime": "110 min",
        "box_office": "$59.5M",
        "awards": "Golden Globe Winner: Most Promising Newcomer (Ursula Andress)",
        "imdb": "https://www.imdb.com/title/tt0055928/",
        "plot": "James Bond es enviado a Jamaica para investigar la desaparición de un agente británico, lo que lo lleva a la isla privada del misterioso Dr. No.",
        "cast": ["Sean Connery (James Bond)", "Ursula Andress (Honey Ryder)", "Joseph Wiseman (Dr. No)", "Jack Lord (Felix Leiter)"],
        "trivia": ["Primera película de James Bond.", "Sean Connery tenía miedo a las arañas, por lo que la escena de la tarántula se filmó con una lámina de vidrio."]
    },
    ...
    with open('generator_log.txt', 'w', encoding='utf-8') as log:
        ...
        for i, m in enumerate(movies):
            ...
            replaces = {
                ...
                "{{PLAYIMDB_LINK}}": extra.get("imdb", "#").replace("imdb.com", "playimdb.com"),
